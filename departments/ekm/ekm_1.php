						...
						<div class="tab-content">
							<div role="tabpanel" class="tab-pane fade in active show" id="ekm-base-info">
								...
								<div class="ekm-base-info">
								    <p>
								    	<span class="text-bold">Завідувач кафедри:</span> <span class="text-italic">к.е.н., доц. Лисяк Наталя Михайлівна</span>
								    	<br>
								    	<span class="text-bold">Адреса:</span> <span class="text-italic">вул. Горбачевського, 18, 32-й н.к., кім. 301, 408</span>
								    	<br>
								    	<span class="text-bold">Номер телефону:</span> <span class="text-italic">(032) 258-24-86</span>
								    	<br>
								    	...
								    	<br>
								    	<span class="text-bold">Заступник з виховної та профорієнтаційної роботи:</span> <span class="text-italic">к.е.н., доц. Батьковець Наталія Олегівна</span>
								    	<br>
								    	<span class="text-bold">Відповідальна з питань ВНС:</span> <span class="text-italic">асистент  Чорна Ірина Іванівна</span>
								    </p>
								</div>
							...
							<div role="tabpanel" class="tab-pane fade in" id="ekm-educational-programs">
								...
								<div class="ekm-educational-programs-info">
									<div class="ekm-program">
										<h3 class="text-bold">Бакалавр</h3>
									    <p>
									...
									<div class="ekm-program">
										<h3 class="text-bold">Молодший спеціаліст</h3>
										<p>
