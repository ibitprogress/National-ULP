...
$news = R::getRow("SELECT * FROM adward WHERE id=".$news_id);
								...
								<div class="col-12 col-md-6 col-lg-12">
									<div class="last-news">
										...
										<div class="last-news-title">
											<h4 class="text-center"><a href="news.php" class="text-green"><?=$l_news['title']; ?></a></h4>
										</div>
								...
								<div class="col-12 col-md-6 col-lg-12">
									<div class="top-news">
										...
										<div class="top-news-title">
											<h4 class="text-center"><a href="news.php" class="text-green"><?=$news_random['title']; ?></a></h4>
										</div>
